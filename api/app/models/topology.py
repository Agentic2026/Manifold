...
class TopologyNode(Base):
    ...
    type = Column(String, nullable=False)  # e.g., "gateway", "frontend", "service", "api", "agent", "database"
...
class TopologyEdge(Base):
    ...
    id = Column(String, primary_key=True, index=True)
    source_id = Column(String, ForeignKey("topology_nodes.id", ondelete="CASCADE"), nullable=False, index=True)
    target_id = Column(String, ForeignKey("topology_nodes.id", ondelete="CASCADE"), nullable=False, index=True)
...
class Vulnerability(Base):
    ...
    affected_node_id = Column(String, ForeignKey("topology_nodes.id", ondelete="CASCADE"), nullable=False, index=True)
...
class LLMInsight(Base):
    ...
    id = Column(String, primary_key=True, index=True)
    node_id = Column(String, ForeignKey("topology_nodes.id", ondelete="CASCADE"), nullable=False, index=True)
