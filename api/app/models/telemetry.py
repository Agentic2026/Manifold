...
class Container(Base):
    ...
    topology_node_id: Mapped[str | None] = mapped_column(
...
class ContainerMetricSnapshot(Base):
    ...
    filesystem_stats: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, nullable=True
    )


Index(
    "ix_container_metric_snapshots_container_id_timestamp",
